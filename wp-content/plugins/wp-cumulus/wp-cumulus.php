...
function wp_cumulus_createflashcode( $widget=false, $atts=NULL ){
	...
	if( $options['compmode']!='true' ){
		...
		$flashtag .= '</p><p>WP Cumulus Flash tag cloud by <a href="http://blueandhack.com">blueandhack</a></div>';
		...
		$flashtag .= '<p>WP-Cumulus by <a href="http://www.popvan.cn/">PopVan.cn</a> and <a href="http://popvan.cn/">Rve</a> requires <a href="http://www.macromedia.com/go/getflashplayer" rel="nofollow">Flash Player</a> 9 or better.</p>';
